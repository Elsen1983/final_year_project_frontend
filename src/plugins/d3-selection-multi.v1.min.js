...
!function (t, n) {
    ...
    function r(n, r) {
        return n.each(function () {
            var n = r.apply(this, arguments), e = t.select(this);
    ...
    function i(n, r, e) {
        return n.each(function () {
            var n = r.apply(this, arguments), i = t.select(this);
    ...
    function s(n, r) {
        return n.each(function () {
            var e = r.apply(this, arguments), i = t.select(this).transition(n);
    ...
    function a(n, r, e) {
        return n.each(function () {
            var i = r.apply(this, arguments), o = t.select(this).transition(n);
